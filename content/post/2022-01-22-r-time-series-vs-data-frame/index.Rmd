...
- **period longer than 2 years**: one year is not enough to establish a seasonal *pattern* over time.
    - if you get <span style="color:red;">'Error in decomposet(<data>): time series has no or less than 2 periods'</span> it is usually due to violating one or both of the above conditions.
